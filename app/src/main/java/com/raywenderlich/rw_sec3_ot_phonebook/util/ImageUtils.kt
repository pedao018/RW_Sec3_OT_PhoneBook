package com.raywenderlich.rw_sec3_ot_phonebook.util
...
object ImageUtils {
    const val AUTHORITY_IMAGE = "com.raywenderlich.rw_sec3_ot_phonebook.fileprovider"
    ...
    * */
    ...
    fun createUniqueImageFile(context: Context): File {
        ...
        val filename = "Phone_" + timeStamp + "_"
